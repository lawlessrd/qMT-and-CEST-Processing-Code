function [PSR,kba,T2a,T2b,R1obs,chi2,chi2p,res,resn] = Analysis_Yarnykh_Full_Fit_CEST(p,varargin)
...
%       p.delatMT - Offset frequencies (in Hz)      added by rdl 04/25/2018
%
% Outputs:
...
[x,chi2,chi2p,res,resn] = fit_SSPulseMT_yarnykh_Full_Fit_CEST(p0,M,pwMT,ts,TR,R1obs,thetaEX,B1eMT,deltaMT+corrB0,lineshape);
