function Vox_Vasily_Full_Fit_R5(Workspace, deltaMT,pwMT,MT_flip,varargin)
%% Vox_Vasily_Full_Fit_R5 - Performs a voxelwise analysis of the Yarnykh method
...
%
% Syntax:  Vox_Vasily_Full_Fit_R5(Workspace, deltaMT,pwMT,MT_flip,kba,T2aR1a,T2b,[Mask])
%
% Inputs:
...
for kk = 2:zmax-1
    display(['Running Slice ' num2str(kk-1) ' of ' num2str(zmax-2)]);
